...
def edit_distance(r, h):
    ...
    '''
    # --- MODIFIED LINE ---
    # Changed dtype from numpy.uint8 to numpy.uint16 (or uint32 if needed for extremely long sequences)
    d = numpy.zeros((len(r) + 1) * (len(h) + 1), dtype=numpy.uint16).reshape((len(r) + 1, len(h) + 1))
    # --- END MODIFIED LINE ---
