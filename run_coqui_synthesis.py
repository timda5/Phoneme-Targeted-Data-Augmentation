...
sentence_files = {
    # NL voices: synthesize sentences with phonemes where NL children have HIGH error rates
    # This gives Whisper more exposure to how NL children pronounce these difficult phonemes
    'nl': analysis_output_folder / 'output_nl_rich_sentences_turbo.txt',
    
    # FR voices: synthesize sentences with phonemes where FR children have HIGH error rates  
    # This gives Whisper more exposure to how FR children pronounce these difficult phonemes
    'fr': analysis_output_folder / 'output_fr_rich_sentences_turbo.txt',
}
